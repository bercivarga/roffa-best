...
import { BiBeer, BiMovie, BiCool, BiWalk, BiFoodMenu, BiHappyBeaming, BiBrain } from 'react-icons/bi';
...
const Popup = ({ detailShowing, handleClose, loc }) => {
	...
	} else if (loc.properties.type === 'culture') {
		icon = <BiBrain className="place-icon" />;
	}
